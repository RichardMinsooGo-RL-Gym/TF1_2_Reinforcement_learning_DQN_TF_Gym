...
class DQN_agent:
    ...
    def build_model(self, network_name):
        ...
        with tf.variable_scope(network_name):
            ...
            model_state = tf.layers.dense(model, self.hidden2, activation=tf.nn.relu)
            model_action = tf.layers.dense(model, self.hidden2, activation=tf.nn.relu)
...
def main():
    ...
    pylab.savefig("./save_graph/mountaincar_duelingdqn.png")
